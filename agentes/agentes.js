...
(function () {
  ...
  var AG_DICT = {
    es: {
      ...
      'ag-hero-sub': 'Explora veinte demostraciones de automatizaci&oacute;n. Presiona play para ver disparadores, herramientas y decisiones con datos de ejemplo, sin conectar sistemas ni ejecutar acciones externas.',
      ...
      'ag-como-2': '<strong>Corre la simulaci&oacute;n.</strong> El robot representa un flujo con datos de ejemplo: disparadores, herramientas y decisiones.',
      'ag-como-3': '<strong>Lee el registro.</strong> La consola muestra los pasos de la simulaci&oacute;n, con marcas de tiempo ilustrativas.',
      ...
      'ag-floor-sub': 'Veinte demostraciones interactivas, agrupadas por &aacute;rea de negocio. Abre cualquier unidad para explorar su flujo simulado.',
      'ag-floor-proof': 'Para conocer mi experiencia y los sistemas en producci&oacute;n, consulta los proyectos &rarr;',
    ...
    en: {
      ...
      'ag-hero-sub': 'Explore twenty automation demos. Press play to follow triggers, tools and decisions using sample data, without connecting systems or taking external actions.',
      ...
      'ag-como-2': '<strong>Run the simulation.</strong> The robot illustrates a workflow with sample data: triggers, tools and decisions.',
      'ag-como-3': '<strong>Read the log.</strong> The console shows simulation steps with illustrative timestamps.',
      ...
      'ag-floor-sub': 'Twenty interactive demos, grouped by business area. Open a unit to explore its simulated workflow.',
      'ag-floor-proof': 'Explore my projects to learn about my experience and production systems &rarr;',
      'ag-legend-label': 'KEY:',
